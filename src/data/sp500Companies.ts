// S&P 500 companies list (updated February 2026)
// Source: Wikipedia "List of S&P 500 companies" + S&P Dow Jones Indices press releases
...
export const sp500Companies: SP500Company[] = [
  ...
  { ticker: "CIEN", name: "Ciena", sector: "Technology" },
  ...
  { ticker: "GGG", name: "Graco", sector: "Industrials" },
  ...
  { ticker: "JBL", name: "Jabil", sector: "Technology" },
  ...
  { ticker: "NTRA", name: "Natera", sector: "Healthcare" },
  ...
  { ticker: "RVTY", name: "Revvity", sector: "Healthcare" },
  ...
  { ticker: "SOLV", name: "Solventum", sector: "Healthcare" },
  ...
  { ticker: "TTD", name: "The Trade Desk", sector: "Communication Services" },
  ...
  { ticker: "XYZ", name: "Block", sector: "Financials" },
