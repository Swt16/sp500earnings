...
export const sp500Companies: SP500Company[] = [
  ...
  { ticker: "CRL", name: "Charles River Labs", sector: "Health Care" },
  ...
  { ticker: "GRMN", name: "Garmin", sector: "Information Technology" },
  ...
  { ticker: "HPQ", name: "HP", sector: "Information Technology" },
  ...
  { ticker: "NTRA", name: "Natera", sector: "Health Care" },
  ...
  { ticker: "PTC", name: "PTC", sector: "Information Technology" },
  ...
  { ticker: "WST", name: "West Pharmaceutical", sector: "Health Care" },
